...
public class ApiClient {
    ...
    private String basePath = "https://api.clever.com/v1.2";
    ...
    public ApiClient(HttpBasicAuth basic) {
    	this();
    	
    	// Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("basic", basic);
        // Prevent the authentications from being modified.
        authentications = Collections.unmodifiableMap(authentications);
        
        setBasePath("https://clever.com");
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.clever.com/v1.2
